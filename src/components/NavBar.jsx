...
const NavBar = () => {
  ...
  return (
    <div className="flex justify-between items-center sm:py-8 sm:px-20 p-4 shadow-md bg-elements custom-text-color">
      {/* LINK SENDS A CLICK USING "TO" TO ANY DESIGNATED PATH , ITS LIKE THE A TAG IN HTML */}
      <Link
        to="/"
